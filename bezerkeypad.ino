...
Serial.println("EAR DRUMS ARE");
lcd.setCursor(0,1);
lcd.print(" PRECIOUS!! ");
Serial.println(" PRECIOUS! ");
delay(1500);
lcd.clear();
lcd.setCursor(1,0);
lcd.print(" WAIT FOR");
...
Serial.println("WANT ME TO");
lcd.setCursor(1,1);
lcd.print("REDICULE MORE??");
Serial.println("REDICULE MORE??");
delay(2500);
lcd.clear();
lcd.setCursor(2,0);
lcd.print("Ha Ha Ha Ha");
Serial.println("Ha Ha Ha Ha");
delay(1700);
lcd.clear();
}
